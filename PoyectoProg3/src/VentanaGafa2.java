...
public class VentanaGafa2 extends JFrame{
	...
	public static void main(String[] args) {
		...
		new VentanaGafa2(new Gafas(label1,"1","Phoebe","negro","Ray-Ban",false,23,89.99,"Las gafas perfectas para la vida"));
	}
